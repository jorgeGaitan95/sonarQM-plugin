 ...
 */
@Rule(key = "IllegalTabCheck", //identificador de la regla
  name = "Tabulation characters should not be used", //nombre de la regla
  priority = Priority.MINOR,  //impacto de la regla
  tags = {"convention"})      //Etiqueta
@BelongsToProfile(title = CheckRepository.SONAR_WAY_PROFILE_NAME, priority = Priority.MINOR)
@SqaleSubCharacteristic(RulesDefinition.SubCharacteristics.READABILITY)
@SqaleConstantRemediation("2min") //Tiempo para solucionar el error
