...
public class RelationshipUseCaseConnectedCheckTest extends AbstractCheckTester{
		...
		XmlSourceCode sourceCode = parseAndCheck(
				createTempFile(
						"<usecase:Diagram xmi:version='2.0' xmlns:xmi='http://www.omg.org/XMI' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:usecase='http://usecase'>"
		    	    		  	...
		    	    		  	+"<listActors name=''/>"
		    	    		  	+"<listRelation xsi:type='usecase:Exclude' source='//@listUseCase.1'/>"
								+"<listRelation xsi:type='usecase:Exclude' source='' target='//@listUseCase.2'/>"
