...
public class DuplicateOperationsClassCheckTest extends AbstractCheckTester{
	Variables var= Variables.getInstance();
	@Test
	  public void checkOperationsClass() throws IOException {
	    		  ...
	    		  + "<itsPackage xsi:type='herramienta.diagrams.domain:Domain_Diagram'>"
	    		  	...
	    		  	+ "<itsClases name='Clase3'>"
	    		  		...
	    		  		+ "<listMetodos name='MTClase3' body='' returnType='void'>"
	    		  			+ "<listParametros name='AtMTClase3'/>"
	    		  			+ "<listParametros name='AtMT2Clase3'/>"
	    		  		+ "</listMetodos>"
	    		  		+ "<listMetodos name='MTClase3' body='' returnType='int'>"
