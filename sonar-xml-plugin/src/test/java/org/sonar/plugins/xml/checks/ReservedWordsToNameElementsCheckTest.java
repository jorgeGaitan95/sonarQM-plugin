	  ...
	  public void checkAttributeTarget() throws IOException {
	    XmlSourceCode sourceCode = parseAndCheck(
	      createTempFile(
	    		  ...
	    		  + 	"<listTable nombreTabla='Persona'>"
	    		  + 		"<listAtributes nombreAtributo='String' tipo='VARCHAR' propiedad='K'/>"
	    		  + "</listTable>"
	    		  + "<listTable nombreTabla='Programa'>"
	    		  + 	"<listAtributes nombreAtributo='NombrePrograma' tipo='VARCHAR' propiedad='K'/>"
	    		  + 	"<listAtributes nombreAtributo='Void' tipo='Int' propiedad='N'/>"
	    		  + 	"<listAtributes nombreAtributo='NombrePrograma3' tipo='VARCHAR' propiedad='N'/>"
	    		  + "</listTable>"
