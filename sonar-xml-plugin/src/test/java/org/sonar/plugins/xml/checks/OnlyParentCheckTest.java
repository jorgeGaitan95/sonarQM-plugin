		...
		XmlSourceCode sourceCode = parseAndCheck(
				createTempFile(
						"<"+var.NODE_DIAGRAM_CTT+" name='ctt1'>"
								...
								+"<"+var.NODE_LIST_RELATION_TASK+" "+var.ATTRIBUTE_XSI_TYPE+"='"+var.CTT_ENABLING+"' "+var.ATTRIBUTE_SOURCE+"='//@itsPackage.1/@listTaskCTT.2' "+var.ATTRIBUTE_TARGET+"='//@itsPackage.1/@listTaskCTT.12'/>"
								...
								+"<"+var.NODE_LIST_RELATION_TASK+" "+var.ATTRIBUTE_XSI_TYPE+"='"+var.CTT_AGREGATION+"' "+var.ATTRIBUTE_SOURCE+"='//@itsPackage.1/@listTaskCTT.0' "+var.ATTRIBUTE_TARGET+"='//@itsPackage.1/@listTaskCTT.14'/>"
								...
								+"<"+var.NODE_LIST_RELATION_TASK+" "+var.ATTRIBUTE_XSI_TYPE+"='"+var.CTT_AGREGATION+"' "+var.ATTRIBUTE_SOURCE+"='//@itsPackage.1/@listTaskCTT.7' "+var.ATTRIBUTE_TARGET+"='//@itsPackage.1/@listTaskCTT.3'/>"
								...
								+"<"+var.NODE_LIST_RELATION_TASK+" "+var.ATTRIBUTE_XSI_TYPE+"='"+var.CTT_INDEPENDENTCONCURRENCY+"' "+var.ATTRIBUTE_SOURCE+"='//@itsPackage.1/@listTaskCTT.1' "+var.ATTRIBUTE_TARGET+"='//@itsPackage.1/@listTaskCTT.2'/>"
